...
from acc_details import acc_details 
# acc_details = {'Account_Name': ('Username', 'Passcode'),}
...
user_xy         = (500, 350)
pass_xy         = (500, 450)
login_button_xy = (500, 800)

################# Clicking #################
pyautogui.click(user_xy)
pyautogui.typewrite(username)

pyautogui.click(pass_xy)
pyautogui.typewrite(passcode)

pyautogui.click(login_button_xy)
